...
function readWriteSync(res) {
    ...
    var newValue = data.replace('new GUIOpts(1, 0.01, 10, 0.01, "World Height")', 'new GUIOpts(0, 0.01, 10, 0.01, "World Height")');
    ...
    data.replace('new GUIOpts(0, 0.01, 10, 0.01, "World Height")', 'new GUIOpts(1, 0.01, 10, 0.01, "World Height")');
    fs.writeFileSync(path.resolve(__dirname + '/../pgen/src/main.js'), newValue, 'utf-8');
}
