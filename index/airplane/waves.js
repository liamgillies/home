...
export default function waves(scene) {
  let material;
  const v = {
    defines: "/index/shaders/defines.glsl",
    header: "/index/shaders/header.glsl",
    main: "/index/shaders/main.glsl",
  };
  const f = {
    defines: "",
    header: "/index/shaders/fheader.glsl",
    main: "/index/shaders/fmain.glsl",
  };
